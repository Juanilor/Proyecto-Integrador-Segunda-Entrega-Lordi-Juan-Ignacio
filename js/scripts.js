...
const protSueContenedor = document.getElementById('protSue-container')
const protVegContenedor = document.getElementById('protVeg-container')
  ...
  for(let i = 0; i <= 3; i++){
    productosStg.forEach(prod => {
      ...
      if(prod.categoria === 'Proteinas S'){
        protSueContenedor.innerHTML += `<div class="custom-card">
            <div class="card-header d-flex">
            <span class="card-discount card-discount-10"
            >Descuento ${prod.descuento}%</span
          >
      ...
      if(prod.categoria === 'Proteinas V'){
        protVegContenedor.innerHTML += `<div class="custom-card">
            <div class="card-header d-flex">
            <span class="card-discount card-discount-10"
            >Descuento ${prod.descuento}%</span
          >
